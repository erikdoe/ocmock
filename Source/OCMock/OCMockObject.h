...
FOUNDATION_EXTERN NS_WARN_UNUSED_RESULT id OCMClassMock(Class cls);
FOUNDATION_EXTERN NS_WARN_UNUSED_RESULT id OCMStrictClassMock(Class cls);
FOUNDATION_EXTERN NS_WARN_UNUSED_RESULT id OCMProtocolMock(Protocol *protocol);
FOUNDATION_EXTERN NS_WARN_UNUSED_RESULT id OCMStrictProtocolMock(Protocol *protocol);
FOUNDATION_EXTERN NS_WARN_UNUSED_RESULT id OCMPartialMock(id obj);
FOUNDATION_EXTERN NS_WARN_UNUSED_RESULT id OCMObserverMock(void);
