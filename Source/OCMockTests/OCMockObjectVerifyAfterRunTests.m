...
{
    id mock = [OCMockObject niceMockForClass:[NSString class] protocols:nil];
...
{
    id mock = [OCMockObject niceMockForClass:[TestBaseClassForVerifyAfterRun class] protocols:nil];
